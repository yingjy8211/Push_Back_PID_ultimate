...
class IMUOdometry:
    ...
    def update(self, dt, current_heading):
        ...
        # Get angular velocity for compensation (derive from heading change)
...
def compensate_wheel_slippage(raw_distance, average_motor_speed):
    ...
    TUNED FOR: 6-wheel drivetrain, 540 RPM top speed, 11W motors
    
    These factors are empirically derived - adjust based on your robot:
    - Low speed (0-40%): Minimal slippage (1.00)
    - Medium speed (40-60%): Slight slippage (0.99)
    - High speed (60-75%): Moderate slippage (0.97)
    - Very high speed (75%+): Significant slippage (0.95)
    ...
    if speed < 40:
        slippage_factor = 1.00  # Minimal slippage
    elif speed < 60:
